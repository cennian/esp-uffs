...
#define CONFIG_UFFS_MAX_PAGE_SIZE 4096
#define CONFIG_UFFS_MAX_CACHED_BLOCK_INFO 128
#define CONFIG_UFFS_MAX_PAGE_BUFFERS 40
#define CONFIG_UFFS_CLONE_BUFFERS_THRESHOLD 2
#define CONFIG_UFFS_MAX_SPARE_BUFFERS 5
#define CONFIG_UFFS_MAX_PENDING_BLOCKS 4
#define CONFIG_UFFS_MAX_DIRTY_PAGES_IN_A_BLOCK 10
#define CONFIG_UFFS_ENABLE_DEBUG_MSG 1
#define CONFIG_UFFS_USE_GLOBAL_FS_LOCK 1
#define CONFIG_UFFS_PAGE_WRITE_VERIFY 1
#define CONFIG_UFFS_USE_SYSTEM_MEMORY_ALLOCATOR 1
#define CONFIG_MOCK_FLASH_SIZE_BLOCKS 1024
